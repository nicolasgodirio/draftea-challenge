...
import (
	...
	"draftea-challenge/createpayment/internal/infra/publisher/kafka"
	"draftea-challenge/createpayment/internal/infra/repository/postgres"
...
func setup() (func(ctx context.Context, req events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error), func(), error) {
	...
	publisher := kafka.NewPaymentPublisher()
